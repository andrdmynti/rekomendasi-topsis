...
<head>
  ...
  <title>Dashboard Panca Jaya Rental</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>P</b>JR</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b>PJR</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-right">
                  <a href="../action/proses_logout.php" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
